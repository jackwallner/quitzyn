...
/// the tree keeps most of its growth, past streaks stay on the record, and
/// every nicotine-free day ever logged is still counted.
    ...
    private var form: some View {
        List {
            ...
            Section {
                ...
                keepRow("calendar", "Every \(HabitVocabulary.cleanDayAdjective) day you've counted still counts")
            } header: {
                Text("What you keep")
            } footer: {
