...
RULES: dict[str, list[tuple[str, str]] | str] = {
    ...
    "hu": [
        ("alkoholmentes", "nikotinmentes"),
        ("alkohol", "nikotin"),
        ("józanság", "nikotinmentes"),
    ],
    "ro": [
        ("fără alcool", "fără nicotină"),
        ("alcool", "nicotină"),
        ("sobri", "fără nicotină"),
        ("sobrietate", "fără nicotină"),
    ],
...
EXTRA_DESC = [
    ...
    ("Geld und Kalorien gespart", "Geld, Beutel und Nikotin gespart"),
    ("Dinero y calorías ahorrados", "Dinero, bolsitas y nicotina evitados"),
    ("Argent et calories économisés", "Argent, sachets et nicotine économisés"),
    ("Alkoholfri dagtæller", "Nikotinfri dagtæller"),
    ("Alkoholfri dagteller", "Nikotinfri dagteller"),
    ("Alkoholfri dagräknare", "Nikotinfri dagräknare"),
    ("Alkoholiton päivälaskuri", "Nikotiiniton päivälaskuri"),
    ("Alkoholmentes napszámláló", "Nikotinmentes napszámláló"),
    ("Alcoholvrije dagteller", "Nikotinvrije dagteller"),
    ("ædrukalender", "nikotinfrikalender"),
    ("edrukalender", "nikotinfrikalender"),
    ("ædru dag", "nikotinfri dag"),
    ("edru dag", "nikotinfri dag"),
    ("raittiina päivänä", "nikotiinittomana päivänä"),
    ("raittiuskalenteri", "nikotiinittomuuskalenteri"),
    ("józansági nappal", "nikotinmentes nappal"),
    ("józansági naptár", "nikotinmentes naptár"),
    ("Nuchterheidskalender", "Nikotinvrijheidskalender"),
    ("Calendario della sobrietà", "Calendario senza nicotina"),
    ("Calendário de sobriedade", "Calendário sem nicotina"),
    ("calendar de sobrietate", "calendar fără nicotină"),
    ("să rămâi sobri", "să rămâi fără nicotină"),
    ("giorni secchi", "giorni senza nicotina"),
    ("días secos", "días sin nicotina"),
    ("dias secos", "dias sem nicotina"),
    ("jours secs", "jours sans nicotine"),
    ("weniger trinkst", "weniger nutzt"),
    ("trockene Tage", "nikotinfreie Tage"),
    ("aufhörst zu Beutel", "mit Beuteln aufhörst"),
